...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, seasonal_holidays|
    puts season.to_s.capitalize! << ":"
      ...
      seasonal_holidays.each do |holiday_name , supplies|
        holiday_name_array = holiday_name.to_s.split("_")
          holiday_name_array.each do |holiday|
            holiday.capitalize!
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.each do |season, seasonal_holidays|
    ...
    seasonal_holidays.each do |holiday_name, supplies_array|
        if supplies_array.include? ("BBQ") 
          #binding.pry
        #supplies_array.each{|bbq_supply| 
        all_bbq_keys.push(holiday_name.to_sym)
      end
    end
